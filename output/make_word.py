...
cp.author = AUTHOR            # Источник → Авторы
cp.last_modified_by = AUTHOR  # Источник → Кем сохранён
cp.title = "Задания в Word"
cp.comments = ""              # убрать "generated by python-docx"
_now = datetime.datetime(2026, 6, 23, 8, 15, 0)
cp.created = _now
cp.modified = _now
